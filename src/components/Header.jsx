...
import logo from '../assets/logo.png'; // Importiamo il logo dei Dolphins
    ...
    <header className="main-header">
      ...
      <nav className="header-nav">
        <ul>
          ...
          <li><NavLink to="/login" className={({ isActive }) => isActive ? 'active-link' : ''}>👤 Accedi / Registrati</NavLink></li>
        </ul>
      </nav>
    </header>
  );
